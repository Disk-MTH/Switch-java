        ...
        try:
            ...
            while True:
                ...
                if regKey_name.lower() == "path":
                    ...
                    os.system("setx Path \"" + os.environ["USERPROFILE"] + "\\switch-java;" + path + "\"")
            ...
            os.system("setx Path \"" + os.environ["USERPROFILE"] + "\\switch-java;\"")
            print("\nIf you have a success notification above, \"Switch-java\" is correctly setup for " + setup_mode + ".")
            os.system("pause")
            sys.exit()
        ...
        try:
            ...
            while True:
                ...
                if regKey_name.lower() == "path":
                    ...
                    os.system("setx -m Path \"" + os.environ["PROGRAMFILES"] + "\\switch-java;" + path + "\"")
                    print("\nIf you have a success notification above, \"Switch-java\" is correctly setup for " + setup_mode + ".")
                    os.system("pause")
                    sys.exit()
            ...
            os.system("setx -m Path \"" + os.environ["PROGRAMFILES"] + "\\switch-java;\"")
            print("\nIf you have a success notification above, \"Switch-java\" is correctly setup for " + setup_mode + ".")
            os.system("pause")
            sys.exit()
